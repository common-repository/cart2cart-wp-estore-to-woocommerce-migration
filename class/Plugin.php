...
class Plugin
{
  const PLUGINS_TITLE = 'Cart2cart: WordPress eStore Plugin to Woocommerce Plugin';
  ...
  const URL_LIMIT = 'from-wordpresseStorePlugin-to-woocommerce';
  const SOURCE_CART_ID = 'WPeStorePlugin';
